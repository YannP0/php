...
<head>
<meta charset="utf-8">
<title>Visualiser les diplômes</title>
...
<H1>Visualiser la liste des diplômes :</H1>
...
<br/>
	...
	echo $data['code_diplome'].' '.$data['intitule'].' '.$data['specialite'].' '.$data['annee'].' '.$data['lieu'].' '.$data['mention'].' '.$data['image'].'<br/>';
	}
	?>
